...
import welcomeImg from '../assets/welcom sign image.png';   // ✅ same image as the hero
...
const navItems = [
  ...
  { to: '/admin/signs',      label: 'Signs' },
  { to: '/admin/audit-logs', label: 'Audit Logs' },
  { to: '/admin/notifications', label: 'Notifications' },
  { to: '/admin/quizzes', label: 'Quizzes' },
  { to: '/admin/enrollments', label: 'Enrollments' },
  { to: '/admin/my-content', label: 'My Content' },
      ...
      <div style={{
        ...
        <img
          ...
          style={{
            ...
            height: '100%',
            objectFit: 'cover',
            objectPosition: 'left center',   // shift focus left like hero
            filter: 'blur(3px)',
            zIndex: -2,
          }}
        />
